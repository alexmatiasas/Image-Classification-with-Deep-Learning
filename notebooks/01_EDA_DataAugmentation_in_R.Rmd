...
### **Sumary so far**
- The CIFAR-10 dataset consists of 32x32 pixel images with 3 color channels.
- **Normalization** prepares the data for further analysis and model input.
...
- **Observations**
  ...
  - The preprocessing step (normalization) has not affected the visual quality.
